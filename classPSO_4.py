...
class psoDNN4:
    ...
    # edit the part below when model is changed
    def modelTraining(self, D1, D2, D3, D4, RSN, metricHistory):
        # model building
    ...
    def bestModel(self, metricHistory, Gbest):    # To see the performance of the best model
        ...
        self.plotTrueAndPredicted(self.xTest, self.yTest, yTestPredicted, "(DNN_4_PSO) [Test]", self.isLoc)
    ...
    def pso(self, particleAmount, maxIterTime):
        ...
        while IterTime < maxIterTime:
            ...
            for particleIdx in range(len(particlePopulation)):
                ...
                # edit the part below when model is changed
                newFitness[particleIdx], metricHistory = self.modelTraining(D1, D2, D3, D4, RSN, metricHistory)

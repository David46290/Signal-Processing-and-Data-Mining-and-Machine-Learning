...
class psoDNN3:
    def __init__(self, x, y, qualityKind, isLoc, normalized):
        ...
        self.isLoc = isLoc
        # self.xTrain, self.yTrain, self.xTest, self.yTest, self.iTrain, self.iTest = self.datasetCreating(x, y, isLoc)
    ...
    def modelTraining(self, D1, D2, D3, RSN, metricHistory):
        # model building
    ...
    def bestModel(self, metricHistory, Gbest):    # To see the performance of the best model
        ...
        self.plotTrueAndPredicted(self.xTest, self.yTest, yTestPredicted, "(DNN_3_PSO) [Test]", self.isLoc)
    ...
    def pso(self, particleAmount, maxIterTime):
        ...
        while IterTime < maxIterTime:
            ...
            for particleIdx in range(len(particlePopulation)):
                ...
                # edit the part below when model is changed
                newFitness[particleIdx], metricHistory = self.modelTraining(D1, D2, D3, RSN, metricHistory)
        ...
        for particleIdx in range(particleAmount):
                ...
                D2 = int(particlePopulation[particleIdx, 1])
                D3 = int(particlePopulation[particleIdx, 2])
                RSN = int(particlePopulation[particleIdx, 3])
